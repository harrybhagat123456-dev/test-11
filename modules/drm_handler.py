...
async def drm_handler(bot: Client, m: Message):
    ...
    if m.document:
        ...
        try:
            if '-' in raw_text:
                start_index = int(raw_text.split('-')[0].lstrip('0') or '1')
                end_index = int(raw_text.split('-')[1].lstrip('0') or '1')
                if start_index > len(links) or end_index > len(links):
                    await editable.edit(f"🔹**Enter number in range of Index (01-{len(links)})**")
                    globals.processing_request = False
                    await m.reply_text("🔹**Processing Cancled......  **")
                    return
            else:
                start_index = int(raw_text.lstrip('0') or '1')
            ...
            await editable.edit(f"🔹**Invalid input. Enter a number or range (e.g., 1 or 1-10)**")
            globals.processing_request = False
            await m.reply_text("🔹**Processing Cancled......  **")
            return
...
#........................................................................................................................................................................................
    ...
    try:
        if '-' in raw_text:
            ...
            end_num = int(raw_text.split('-')[1].lstrip('0') or '1')
            if start_num > end_num:
                await m.reply_text(f"🔹**Invalid range: start ({start_num}) is greater than end ({end_num})**")
                globals.processing_request = False
                return
            count = start_num
            arg = start_num
            ...
            if m.text:
                if "youtu" in url:
                    try:
                        ...
                        audio_title = name1[:60] if name1 else f"YouTube_Video_{count:03d}"
...
#........................................................................................................................................................................................
            ...
            if "acecwply" in url:
                ...
                try:
                    ...
                    data = response.json()
                    if 'url' not in data:
                        raise Exception(f"Classplus API error: {data.get('error', 'Invalid response - token may be expired')}")
                    url = data['url']
                except Exception as e:
...
#........................................................................................................................................................................................           
                if "drive" in url:
                    ...
                    try:
                        ...
                        await m.reply_text(f"⚠️ Image download failed: {str(e)}")
                        continue    
                    ...
                    try:
                        ...
                        await m.reply_text(f"⚠️ Audio download failed: {str(e)}")
                        continue    
    ...
    try:
        if '-' in raw_text:
            ...
            end_idx = int(raw_text.split('-')[1].lstrip('0') or '1')
